    ...
    Slick = function() {
        function Slick(element, settings) {
            ...
            if (_.defaults = {
                ...
                touchObject: {},
                transformsEnabled: !1
            }, $.extend(_, _.initials), _.activeBreakpoint = null, 
            _.animType = null, _.animProp = null, _.breakpoints = [], 
            _.breakpointSettings = [], _.cssTransitions = !1, 
            _.hidden = "hidden", _.paused = !1, _.positionProp = null, 
            _.respondTo = null, _.rowCount = 1, _.shouldClick = !0, 
            _.$slider = $(element), _.$slidesCache = null, _.transformType = null, 
            _.transitionType = null, _.visibilityChange = "visibilitychange", 
            ...
            _.visibilityChange = "mozvisibilitychange") : "undefined" != typeof document.msHidden ? (_.hidden = "msHidden", 
        ...
        index = null; else if (0 > index || index >= _.slideCount) return !1;
        ...
        if (_.options.dots === !0 && _.slideCount > _.options.slidesToShow) {
            ...
            i = 0; i <= _.getDotCount(); i += 1) dotString += "<li>" + _.options.customPaging.call(this, _, i) + "</li>";
            dotString += "</ul>", _.$dots = $(dotString).appendTo(_.options.appendDots), 
        ...
        _.slideCount = _.$slides.length, _.$slides.each(function(index, element) {
            $(element).attr("data-slick-index", index);
        }), _.$slidesCache = _.$slides, _.$slider.addClass("slick-slider"), 
        ...
        _.setupInfinite(), _.buildArrows(), _.buildDots(), 
        _.updateDots(), _.options.accessibility === !0 && _.$list.prop("tabIndex", 0), 
        ...
        originalSlides = _.$slider.children(), _.options.rows > 1) {
        ...
        _.originalSettings.responsive && _.originalSettings.responsive.length > -1 && null !== _.originalSettings.responsive) {
            ...
            _.refresh())) : (_.activeBreakpoint = targetBreakpoint, 
            "unslick" === _.breakpointSettings[targetBreakpoint] ? _.unslick() : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[targetBreakpoint]), 
            initial === !0 && (_.currentSlide = _.options.initialSlide), 
            _.refresh())) : null !== _.activeBreakpoint && (_.activeBreakpoint = null, 
        ...
        $target.is("a") && event.preventDefault(), unevenOffset = _.slideCount % _.options.slidesToScroll !== 0, 
        ...
        if (navigables = _.getNavigableIndexes(), prevNavigable = 0, 
        index > navigables[navigables.length - 1]) index = navigables[navigables.length - 1]; else for (var n in navigables) {
        ...
        _.$list.off("click.slick", _.clickHandler), _.options.autoplay === !0 && $(document).off(_.visibilityChange, _.visibility), 
        _.$list.off("mouseenter.slick", _.setPaused.bind(_, !0)), 
        _.$list.off("mouseleave.slick", _.setPaused.bind(_, !1)), 
        ...
        originalSlides.removeAttr("style"), _.$slider.html(originalSlides));
        ...
        var _ = this;
        _.autoPlayClear(), _.touchObject = {}, _.cleanUpEvents(), 
        $(".slick-cloned", _.$slider).remove(), _.$dots && _.$dots.remove(), 
        ...
        return _.slideOffset = 0, verticalHeight = _.$slides.first().outerHeight(), 
        ...
        verticalOffset = 0), _.options.centerMode === !0 && _.options.infinite === !0 ? _.slideOffset += _.slideWidth * Math.floor(_.options.slidesToShow / 2) - _.slideWidth : _.options.centerMode === !0 && (_.slideOffset = 0, 
        ...
        _.buildRows(), _.buildOut(), _.setProps(), _.startLoad(), 
        _.loadSlider(), _.initializeEvents(), _.updateArrows(), 
        _.updateDots()), _.$slider.trigger("init", [ _ ]);
        ...
        _.initArrowEvents(), _.initDotEvents(), _.$list.on("touchstart.slick mousedown.slick", {
            ...
            action: "end"
        }, _.swipeHandler), _.$list.on("click.slick", _.clickHandler), 
        _.options.autoplay === !0 && $(document).on(_.visibilityChange, _.visibility.bind(_)), 
        _.$list.on("mouseenter.slick", _.setPaused.bind(_, !0)), 
        _.$list.on("mouseleave.slick", _.setPaused.bind(_, !1)), 
        ...
        _.setPosition(), _.$slideTrack.css({
            opacity: 1
        }), _.$slider.removeClass("slick-loading"), _.initUI(), 
        ...
        var _ = this;
        _.$slider.trigger("afterChange", [ _, index ]), _.animating = !1, 
        _.setPosition(), _.swipeLeft = null, _.options.autoplay === !0 && _.paused === !1 && _.autoPlay();
        ...
        _.updateArrows(), _.initArrowEvents(), _.buildDots(), 
        _.updateDots(), _.initDotEvents(), _.options.focusOnSelect === !0 && $(_.$slideTrack).children().on("click.slick", _.selectHandler), 
        ...
        _.$slides = _.$slideTrack.children(this.options.slide), 
        _.$slideTrack.children(this.options.slide).detach(), 
        _.$slideTrack.append(_.$slides), _.$slidesCache = _.$slides, 
        void _.reinit());
        ...
        positionProps[_.positionProp] = position, _.transformsEnabled === !1 ? _.$slideTrack.css(positionProps) : (positionProps = {}, 
        ...
        var _ = this;
        _.options[option] = value, refresh === !0 && (_.unload(), 
        _.reinit());
        ...
        _.transformType = "-o-transform", _.transitionType = "OTransition", 
        ...
        _.transformType = "-moz-transform", _.transitionType = "MozTransition", 
        ...
        _.transformType = "-ms-transform", _.transitionType = "msTransition", 
        ...
        _.slideCount > _.options.slidesToShow)) {
            ...
            for (i = 0; infiniteCount > i; i += 1) slideIndex = i, 
        ...
        _.options.centerMode === !0 && (_.$slider.find(".slick-slide").removeClass("slick-center"), 
        ...
        targetSlide = index, targetLeft = _.getLeft(targetSlide), 
        slideLeft = _.getLeft(_.currentSlide), _.currentLeft = null === _.swipeLeft ? slideLeft : _.swipeLeft, 
        ...
        oldSlide = _.currentSlide, _.currentSlide = animSlide, 
        _.setSlideClasses(_.currentSlide), _.updateDots(), 
        _.updateArrows(), _.options.fade === !0 ? (dontAnimate !== !0 ? _.fadeSlide(animSlide, function() {
        ...
        r = Math.atan2(yDist, xDist), swipeAngle = Math.round(180 * r / Math.PI), 
        ...
        if (_.dragging = !1, _.shouldClick = _.touchObject.swipeLength > 10 ? !1 : !0, 
        ...
        _.touchObject.swipeLength >= _.touchObject.minSwipe) switch (_.swipeDirection()) {
          case "left":
            ...
            _.slideHandler(slideCount), _.currentDirection = 0, 
            _.touchObject = {}, _.$slider.trigger("swipe", [ _, "left" ]);
            break;

          case "right":
            slideCount = _.options.swipeToSlide ? _.checkNavigable(_.currentSlide - _.getSlideCount()) : _.currentSlide - _.getSlideCount(), 
            _.slideHandler(slideCount), _.currentDirection = 1, 
            _.touchObject = {}, _.$slider.trigger("swipe", [ _, "right" ]);
        ...
        swipeLength = _.touchObject.swipeLength, _.touchObject.edgeHit = !1, 
        ...
        _.options.arrows === !0 && _.options.infinite !== !0 && _.slideCount > _.options.slidesToShow && (_.$prevArrow.removeClass("slick-disabled"), 
        ...
        var _ = this;
        document[_.hidden] ? (_.paused = !0, _.autoPlayClear()) : (_.paused = !1, 
        _.autoPlay());
    }, $.fn.slick = function() {
...
$(document).ready(function() {
    var $nextArrow = '<div class="slick-next">&#xf105;</div>', $prevArrow = '<div class="slick-prev">&#xf104;</div>';
    // Main Slider 
