!function() {
	...
	*/
    ...
    FastClick.prototype.onTouchStart = function(event) {
        ...
        touch = event.targetTouches[0], deviceIsIOS) {
        ...
        return this.trackingClick = !0, this.trackingClickStart = event.timeStamp, 
        this.targetElement = targetElement, this.touchStartX = touch.pageX, 
        this.touchStartY = touch.pageY, event.timeStamp - this.lastClickTime < this.tapDelay && event.preventDefault(), 
        !0;
    }, /**
    ...
    FastClick.prototype.onTouchEnd = function(event) {
        ...
        this.cancelNextClick = !1, this.lastClickTime = event.timeStamp, 
        trackingClickStart = this.trackingClickStart, this.trackingClick = !1, 
        ...
        !1) : (this.focus(targetElement), this.sendClick(targetElement, event), 
    ...
    FastClick.prototype.onClick = function(event) {
        ...
        this.trackingClick = !1, !0) : "submit" === event.target.type && 0 === event.detail ? !0 : (permitted = this.onMouse(event), 
    ...
    }, "function" == typeof define && "object" == typeof define.amd && define.amd ? // AMD. Register as an anonymous module.
    define(function() {
        return FastClick;
