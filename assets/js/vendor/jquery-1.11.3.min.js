 ...
 */
    ...
    function internalData(elem, name, data, pvt) {
        if (jQuery.acceptData(elem)) {
            ...
            thisCache = thisCache.data), void 0 !== data && (thisCache[jQuery.camelCase(name)] = data), 
 ...
 */
    function defaultDisplay(nodeName) {
        ...
        doc.write(), doc.close(), display = actualDisplay(nodeName, doc), 
        iframe.detach()), elemdisplay[nodeName] = display), 
        display;
    }
    ...
    function showHide(elements, show) {
        ...
        display = elem.style.display, show ? (// Reset the inline display of this element to learn if it is
 ...
 */
    function ajaxConvert(s, response, jqXHR, isSuccess) {
        ...
        if ("*" === current) current = prev; else if ("*" !== prev && prev !== current) {
            ...
            !conv) for (conv2 in converters) if (// If conv2 outputs current
                    ...
                    return 1 === first && 0 === last ? function(elem) {
                        ...
                        if (parent) {
                            ...
                            forward && useCache) {
                                ...
                                diff = cache[0] === dirruns && cache[2], node = nodeIndex && parent.childNodes[nodeIndex]; node = ++nodeIndex && node && node[dir] || (// Fallback to seeking `elem` from the start
 ...
 */
    ...
    rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function(selector, context) {
        ...
        if ("string" == typeof selector) {
            ...
            return this.context = document, this.selector = selector, 
            this;
        }
 ...
 */
    ...
    jQuery(function() {
        ...
        val && (// Prevent IE 6 from affecting layout for positioned elements #11048
 ...
 */
    ...
    jQuery.extend({
        ...
        promise: function(type, obj) {
            ...
            type = type || "fx"; i--; ) tmp = jQuery._data(elements[i], type + "queueHooks"), 
    ...
    var pnum = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, cssExpand = [ "Top", "Right", "Bottom", "Left" ], isHidden = function(elem, el) {
        ...
        raw ? (fn.call(elems, value), fn = null) : (bulk = fn, 
 ...
 */
    ...
    wrapMap.th = wrapMap.td, jQuery.extend({
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            !(support.noCloneEvent && support.noCloneChecked || 1 !== elem.nodeType && 11 !== elem.nodeType || jQuery.isXMLDoc(elem))) // Fix all IE cloning issues
            ...
            i = 0; null != (node = srcElements[i]); ++i) // Ensure that the destination node is not null; Fixes #9587
        ...
        buildFragment: function(elems, context, scripts, selection) {
            ...
            if ("object" === jQuery.type(elem)) jQuery.merge(nodes, elem.nodeType ? [ elem ] : elem); else if (rhtml.test(elem)) {
                ...
                "<table>" !== wrap[1] || rtbody.test(elem) ? 0 : tmp : tmp.firstChild, 
    ...
    !function() {
        ...
        support.shrinkWrapBlocks = function() {
            ...
            shrinkWrapBlocksVal = 3 !== div.offsetWidth), body.removeChild(container), 
    ...
    window.getComputedStyle ? (getStyles = function(elem) {
        ...
        style.left = "fontSize" === name ? "1em" : ret, ret = style.pixelLeft + "px", 
        style.left = left, rsLeft && (rs.left = rsLeft)), 
        ...
        function computeStyleTests() {
            ...
            div.style.width = "1px", reliableMarginRightVal = !parseFloat((window.getComputedStyle(contents, null) || {}).marginRight), 
        ...
        support.cssFloat = !!style.cssFloat, div.style.backgroundClip = "content-box", 
    ...
    jQuery.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                void 0 === value) // If a hook was provided get the non-computed value from there
    ...
    jQuery.fn.delay = function(time, type) {
        ...
        // Setup
        div = document.createElement("div"), div.setAttribute("className", "t"), 
        div.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", 
        ...
        input = document.createElement("input"), input.setAttribute("value", ""), 
    ...
    try {
        ...
        ajaxLocation = document.createElement("a"), ajaxLocation.href = "", 
		...
		*/
        ...
        ajax: function(url, options) {
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                s.ifModified && (modified = jqXHR.getResponseHeader("Last-Modified"), 
                ...
                error = statusText, (status || !statusText) && (statusText = "error", 
                0 > status && (status = 0))), // Set data for the fake xhr object
        ...
        if (s.crossDomain) {
            ...
            return {
                send: function(_, callback) {
                    script = document.createElement("script"), script.async = !0, 
 ...
 */
    ...
    jQuery.offset = {
        setOffset: function(elem, options, i) {
            ...
            curCSSLeft = jQuery.css(elem, "left"), calculatePosition = ("absolute" === position || "fixed" === position) && jQuery.inArray("auto", [ curCSSTop, curCSSLeft ]) > -1, 
